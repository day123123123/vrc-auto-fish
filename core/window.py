...
class WindowManager:
    ...
    def find(self) -> bool:
        ...
        if results:
            ...
            self._update_rect()
            log.info(t("log.window_found", title=self._title, hwnd=self.hwnd))
            return True

        log.warning(t("log.window_not_found", keyword=self.title_keyword))
        self.hwnd = None
        return False
    ...
    def focus(self) -> bool:
        ...
        try:
            ...
            log.warning(t("log.window_focus_fail", e=e))
            return False
